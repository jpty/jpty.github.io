...
## Configuration pour l'utilisation de la source Météo France
Le plugin utilise les APIs Bulletin Vigilance et Météo des forêts.
Dans la configuration du plugin, il est nécessaire de renseigner l'APPLICATION_ID permettant l'accès à ces APIs et de cocher l'utilisation.
Voir la [**procédure de récupération de l'APPLICATION_ID**](https://community.jeedom.com/t/actualites-du-plugin-weather-forecast-cap-alerts/135292/19?u=jpty).
...
- Sélectionnez le template d'affichage. Icônes, Images ou Pas de template
  ...
  Avec le choix "Pas de template", seule la commande "H0Json pour widget" est affichée. Le widget ClockWF du plugin lui est affecté.
